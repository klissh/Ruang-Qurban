...
const ROLE_BADGE: Record<Role, { bg: string; color: string; border: string }> = {
  SUPER_ADMIN:       { bg: 'rgba(167,139,250,0.12)', color: '#c4b5fd', border: 'rgba(167,139,250,0.22)' },
  ADMIN_PENDAFTARAN: { bg: 'rgba(96,165,250,0.12)',  color: '#60a5fa', border: 'rgba(96,165,250,0.22)' },
  PETUGAS_LAPANGAN:  { bg: 'rgba(251,191,36,0.12)',  color: '#fbbf24', border: 'rgba(251,191,36,0.22)' },
}
