...
// Render langsung ke document.body — bebas dari overflow parent
...
export default function PanitiaClient({ anggotaList, workspaceRoles, currentUserId, workspaceId, slug }: Props) {
  ...
  function resolveProfileRole(rId: string): string {
  ...
  return (
    <div className="p-6 md:p-8 max-w-3xl mx-auto animate-slide-up">
      ...
      {/* Modal Tambah — render via portal */}
      {showModal && (
        <ModalPortal>
          <div
            onClick={(e) => { if (e.target===e.currentTarget) setShowModal(false) }}
            style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.62)', backdropFilter:'blur(10px)', zIndex:9999, display:'flex', overflowY:'auto', padding:'24px 16px' }}
          >
