...
export default function ArsipDetailClient({ periode, hewanList, jamaahList, userRole, adaPeriodeAktifLain, slug }: Props) {
  ...
  return (
    <div className="p-6 md:p-8 pb-20 md:pb-8 max-w-5xl mx-auto animate-slide-up">
      ...
      <div style={{ marginBottom: 24 }}>
        <Link href={`/w/${slug}/arsip`} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', marginBottom: 16 }}>
